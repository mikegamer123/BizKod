...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-center">
        <h1 class="h2 py-4"><b>Unfinished Events</b></h1>
    </div>
    <hr>
    ...
    <div class="d-flex justify-content-around">
        ...
        <div class="card" style="width: 18rem;">
            <img src="./images/map.jpg" class="card-img-top img-fluid" alt="map">
            <div class="card-body">
                <h5 class="card-title">Event title</h5>
                <p class="card-text">organizator</p>
            </div>
            ...
            <div class="card-body d-flex justify-content-center">
                <button class="m-auto btn btn-danger">Block this event</button>
            </div>
        </div>
    </div>
