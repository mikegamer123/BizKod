    ...
    <div class="d-flex justify-content-center pt-5">
        <div class="col-12 col-md-8 col-xl-6d">
            <div class="d-flex justify-content-center">
                <h1 class="h2 py-2"><b>Create User</b></h1>
            </div>
            <hr>
            ...
            <div>
                ...
                <input class="form-control" name="first_name" id="first_name"> <br>
                <label for="last_name">Last name: </label> <br>
                <input class="form-control" name="last_name" id="last_name"> <br>
                <label for="position">Position: </label> <br>
                <input class="form-control" name="position" id="position"> <br>
                <label for="email">Email: </label> <br>
                <input class="form-control" name="email" id="email"> <br>
                <label for="password">Password: </label> <br>
                <input class="form-control" type="password" name="password" id="password"> <br>
                   New employee?: <input type="checkbox" name="new_employee"><br>
                    <label for="phone_number" class="mt-4">Phone Number: </label> <br>
                    <input class="form-control" type="text" name="phone_number" id="password">
                    <input  class="form-control mt-4" type="date" name="date_of_birth">
                    <br>
                    <select name="gender" class="form-control mt-4" id="">
                        <option value="m">Male</option>
                        <option value="m">Female</option>
                    </select>
                <div class="d-flex justify-content-center m-4">
                    <button class="m-auto btn btn-dark" type="submit" name="submit" id="submit">Create! </button>
                </div>
                </form>
            </div>
